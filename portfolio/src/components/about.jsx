      ...
      className='text-center text-5xl font-Ovo'>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                ...
                >Passionné par l'informatique, je poursuis actuellement un mastère Expert en Cybersécurité à Live Campus, en alternance chez TotalEnergies Proxy Sud-Ouest.
