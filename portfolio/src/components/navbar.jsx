    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
                <a href="#top">
                    <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt='' className='w-50 cursor-pointer mr-14' />
                </a>

                <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"}`}>
                    <li><a className='font-Ovo hover:text-[#F0AD4E]' href="#top">Accueil</a></li>
                    <li><a className='font-Ovo hover:text-[#F0AD4E]' href="#about">Moi</a></li> 
                    <li><a className='font-Ovo hover:text-[#F0AD4E]' href="#work">Mes projets</a></li>
                </ul>
            ...
            <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-orange-50 transition duration-500 dark:bg-darkHover dark:text-white'>
